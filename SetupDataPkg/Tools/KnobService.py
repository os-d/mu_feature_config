...
def get_spdx_header(header, efi_type):
    ...
    spdx += get_spacing_string(efi_type)
    spdx += "SPDX-License-Indentifier: BSD-2-Clause-Patent"
    spdx += get_line_ending(efi_type)
    spdx += get_line_ending(efi_type)
    spdx += "**/"
    spdx += get_line_ending(efi_type)
...
def usage():
    print("Commands:\n")
    print("  generateheader[_efi] <schema.xml> <public_header.h> <service_header.h> [<data_header.h>] [<profile_header.h> <profile.csv>...]")
    print("")
